...
fn ec_params_256_bit<C: Curve>() -> ECParams {
    ...
    if C::ORDER.to_be_byte_array().as_slice() == SECP256K1_ORDER.as_slice() {
        base_field_params = DynResidueParams::<4>::new(&U256::from_be_bytes(SECP256K1_BASE_FIELD_ORDER));
        ...
        base_field_params = DynResidueParams::<4>::new(&U256::from_be_bytes(SECP256R1_BASE_FIELD_ORDER));
